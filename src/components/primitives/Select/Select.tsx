...
>(
  (
    { className, variant, size, options, placeholder, error, errorMessage, isLoading, ...props },
    ref
  ) => {
    ...
    if (isLoading) {
      ...
      return (
        <div className="w-full">
          <Skeleton className={cn(heightClass, 'w-full rounded-md', className)} />
        </div>
      );
    }
